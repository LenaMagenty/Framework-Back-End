...
class AuthService(BaseService):
    ...
    def register_user(self, register_request: RegisterRequest) -> SuccessResponse:
        response = self.authorization_helper.post_register(data=register_request.model_dump()) # Сериализацию можно настроить.
    ...
    def login_user(self, login_request: LoginRequest) -> LoginResponse:
        ...
        return LoginResponse(**response.json()) # Десереализация обратно в модель.
